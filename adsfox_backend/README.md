...
* Delete post by id:
  * DELETE http://127.0.0.1:8000/canals/1 <br/>
...
* Update canal:
  * PUT http://127.0.0.1:8000/canals/1 <br/>
...
* List info about percent all canals
  * GET http://127.0.0.1:8000/canals/percentages <br/>
...
# 6. Run Unit Tests
* open a new terminal window
* paste the presented fragment: ./vendor/bin/phpunit <br/>
